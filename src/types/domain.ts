...
export type Usuario = { id: string; name: string; company?: string | null; email: string; role: Role; status: "ACTIVE" | "INACTIVE"; notes?: string | null; lastLoginAt?: string | null; createdAt?: string | null; updatedAt?: string | null; authUserId?: string | null };
