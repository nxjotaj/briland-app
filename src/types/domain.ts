...
export type ModeloVeiculo = { id: string; nome: string; slug?: string | null; montadoraId: string; anoInicial?: number | null; anoFinal?: number | null; ativo?: boolean | null; createdAt?: string | null; updatedAt?: string | null };
...
export type Usuario = { id: string; name: string; company?: string | null; email: string; role: Role; status: "PENDING" | "ACTIVE" | "INACTIVE"; notes?: string | null; phone?: string | null; cnpj?: string | null; stateRegistration?: string | null; address?: string | null; zipCode?: string | null; neighborhood?: string | null; city?: string | null; state?: string | null; representanteId?: string | null; orderDiscountLimit?: number | null; registrationNotes?: string | null; approvedAt?: string | null; approvedBy?: string | null; lastLoginAt?: string | null; createdAt?: string | null; updatedAt?: string | null; authUserId?: string | null };
...
export type AppData = {
  ...
  produtoModelosVeiculo: ProdutoModeloVeiculoView[];
  usuarios: Usuario[];
  leads: Lead[];
